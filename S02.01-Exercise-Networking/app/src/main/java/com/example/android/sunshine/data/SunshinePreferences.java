...
public class SunshinePreferences {
     ...
     */
    private static final String DEFAULT_WEATHER_LOCATION = "Swanton,USA";
    private static final double[] DEFAULT_WEATHER_COORDINATES = {41.59, -83.89};

    private static final String DEFAULT_MAP_LOCATION =
            "25 Canada St, Swanton, Vermont 05488";
