...
public class MainActivity extends AppCompatActivity {
    ...
    // compete (31) Create a setWeatherData method that saves the weatherData to mWeatherData
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // complete (40) Use setHasFixedSize(true) on mRecyclerView to designate that all items in the list will have the same
