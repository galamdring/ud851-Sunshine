...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String ZIPCODEEXTRAID = "zipCodeExtra!" ;
    private static final int WEATHER_LOADER_ID = 4245;
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                if (!args.containsKey(ZIPCODEEXTRAID)) {
                    return null;
                }

                String location = args.getString(ZIPCODEEXTRAID);
            ...
            protected void onStartLoading() {
                ...
                if(JsonWeatherDataCache!=null) {
                    deliverResult(JsonWeatherDataCache);
                    return;
                }
            ...
            public void deliverResult(String[] data) {
                JsonWeatherDataCache=data;
                super.deliverResult(data);
            }
        };
    }
    String[] JsonWeatherDataCache;
    ...
    void initLoader(String location){
        Bundle weatherBundle = null;
        if(location!=null){
            weatherBundle = new Bundle();
            weatherBundle.putString(ZIPCODEEXTRAID,location);
        }
        LoaderManager loadManager = getSupportLoaderManager();
        Loader<String[]> weatherLoader = loadManager.getLoader(WEATHER_LOADER_ID);
        if(weatherLoader==null){
            loadManager.initLoader(WEATHER_LOADER_ID, weatherBundle, this );
        }
        else{
            loadManager.restartLoader(WEATHER_LOADER_ID, weatherBundle, this);
        }
    }
    @Override
