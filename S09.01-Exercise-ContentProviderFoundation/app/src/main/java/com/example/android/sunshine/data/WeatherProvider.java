...
// Completed   TODO (5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
static final int CODE_WEATHER = 200;
static final int CODE_WEATHER_WITH_DATE =201;
// Completed   TODO (7) Instantiate a static UriMatcher using the buildUriMatcher method
    static final UriMatcher sUriMatcher = buildUriMatcher();

    WeatherDbHelper mOpenHelper;

// Completed   TODO (6) Write a method called buildUriMatcher where you match URI's to their numeric ID
...
// Completed   TODO (1) Implement onCreate
    @Override
    public boolean onCreate() {
// Completed       TODO (2) Within onCreate, instantiate our mOpenHelper
        mOpenHelper = new WeatherDbHelper(getContext());
// Completed       TODO (3) Return true from onCreate to signify success performing setup
        return true;
    }
...
// Completed  TODO (8) Provide an implementation for the query method
    /**
...
// Completed       TODO (9) Handle queries on both the weather and weather with date URI

// Completed       TODO (10) Call setNotificationUri on the cursor and then return the cursor
